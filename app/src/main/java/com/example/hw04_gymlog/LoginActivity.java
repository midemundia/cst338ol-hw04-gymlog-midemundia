...
import com.example.hw04_gymlog.databinding.ActivityLoginBinding;
        ...
        userObserver.observe(this, user -> {
            if(user != null) {
                ...
                if(password.equals(user.getPassword())) {
                    /*
                    //Get a reference to the shared preferences from non-volatile memory and start MainActivity
